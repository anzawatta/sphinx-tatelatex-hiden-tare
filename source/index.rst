...
『ごん狐』は、 :kansuji:`1932` （昭和 :kansuji:`7` ）年に :ruby:`新美南吉<にいみなんきち>` が『赤い鳥』で発表した童話。

文中のルビ、傍線、圏点、註はPDF生成の例として付与した。
...
　その中山から、少しはなれた山の中に、「ごん :ruby:`狐<ぎつね>` 」という狐がいました。ごんは、一人ぼっちの小狐で、 :kenten:`しだ` の一ぱいしげった森の中に穴をほって住んでいました。そして、夜でも昼でも、あたりの村へ出てきて、いたずらばかりしました。はたけへ入って芋をほりちらしたり、 :ruby:`菜種<なたね>` がらの、ほしてあるのへ火をつけたり、百姓家の裏手につるしてある :kasen:`とんがらし` をむしりとって、いったり、いろんなことをしました。
　:ruby:`或<ある>` 秋のことでした。二、三日雨がふりつづいたその間、ごんは、外へも出られなくて穴の中にしゃがんでいました。
