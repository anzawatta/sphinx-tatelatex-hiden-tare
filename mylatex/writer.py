...
class MyLaTeXWriter(writers.Writer):
...
class LaTeXTranslator(SphinxTranslator):
    ...
    def restrict_footnote(self, node):
        # type: (nodes.Element) -> None
        warnings.warn('MyLaTeXWriter.restrict_footnote() is deprecated.',
                      RemovedInSphinx30Warning, stacklevel=2)
    ...
    def unrestrict_footnote(self, node):
        # type: (nodes.Element) -> None
        warnings.warn('MyLaTeXWriter.unrestrict_footnote() is deprecated.',
                      RemovedInSphinx30Warning, stacklevel=2)
    ...
    def visit_footnote(self, node):
        ...
        self.body.append('\\sphinxAtStartFootnote\n(\\rotatebox[origin=c]{90}{%s})' % label.astext())
    ...
    def collect_footnotes(self, node):
        ...
        warnings.warn('MyLaTeXWriter.collected_footnote() is deprecated.',
    ...
    def footnotestack(self):
        ...
        warnings.warn('MyLaTeXWriter.footnotestack is deprecated.',
                      RemovedInSphinx30Warning, stacklevel=2)
        return []
