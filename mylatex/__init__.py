...
import sphinx.ext.mylatex.nodes  # NOQA  # Workaround: import this before writer to avoid ImportError
from sphinx import package_dir, addnodes, highlighting
from sphinx.builders import Builder
from sphinx.ext.mylatex.util import ExtBabel
...
from sphinx.ext.mylatex.writer import(
    MyLaTeXWriter, LaTeXTranslator
)
...
class MyLaTeXBuilder(Builder):
    ...
    def apply_transforms(self, doctree):
        ...
        warnings.warn('MyLaTeXBuilder.apply_transforms() is deprecated.',
